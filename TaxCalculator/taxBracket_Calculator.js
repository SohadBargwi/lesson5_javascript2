        ...
        ***********************************************************************************************/
        ...
        if (status == 0) { 
          ...
          *******************************************************************************/
             ...
             // Compute tax for Married filing jointly or qualifying widow(er) filers
                 if (income <= 19050){
                 tax = income * 0.10;
                 taxRate = 10;
               }//end of nested if
                 ...
                 tax = 19050 * 0.10 + (77400 - 19050) * 0.12 +
                       (165000 - 77400) * 0.22 + (income - 77400) * 0.24;
                 taxRate = 24;
               }//end of else if
          ...
          *******************************************************************************/
             ...
             // Compute tax for Married filing separately filers
               if (income <= 9525){
                 tax = income * 0.10;
                 taxRate = 10;
               }//end of nested if
...
function clearButton () {
             ...
             //INSERT YOUR CODE BELOW
              ...
              //This code resets the dropdown box to the "Married filing jointly or qualifying widow(er)" filer status.
              document.getElementById("filingStatus").selectedIndex = 0;

              //This code resets the dropdown box to the "Married filing separately" filer status.
              document.getElementById("filingStatus").selectedIndex = 0;
